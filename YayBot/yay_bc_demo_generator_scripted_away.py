...
def main():
    ...
    save_name = "{}-{}-{}-{}-{}".format(args.save_directory, args.bot_type,
                                                                   args.botbowl_size,
                                                                   args.reward_function, args.model_name)
    ...
    env_config = {
        ...
        #                   away_agent='random'),
        "env": BotBowlEnv(env_conf=EnvConf(size=args.botbowl_size), seed=args.seed, home_agent='random',
                          away_agent='human'),
        "reset_obs": reset_obs,
    ...
    if args.bot_type == "scripted" and args.botbowl_size != 11:
        ...
        agent = ppo.PPOTrainer(env="single_agent_bot_bowl_env", config=restore_config)
    ...
    for episode_id in range(num_episodes):
        ...
        test_bot.new_game(env.env.game, env.env.env.away_team)
