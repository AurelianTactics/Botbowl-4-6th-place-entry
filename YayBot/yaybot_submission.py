...
def get_ray_trainer(agent_name, model_config, is_ma_bot=True):
...
def get_bot_policy(bot, name, model_config):
    bot.trainer, bot.policy_id = get_ray_trainer(name, model_config)
    return bot
